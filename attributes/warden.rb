default['mapr']['warden']['config'] = {
  ...
  'service.command.webserver.start' => '/opt/mapr/apiserver/bin/mapr-apiserver.sh start',
  ...
  'service.command.webserver.stop' => '/opt/mapr/apiserver/bin/mapr-apiserver.sh stop',
  ...
  'service.command.webserver.monitorcommand' => '/opt/mapr/apiserver/bin/mapr-apiserver.sh status',
